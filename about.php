  ...
  <style>
     ...
     .navbar
       ...
       #about
       {
        ...
        height: 200px;
        width: 100%;
        background:linear-gradient(white,blue,white,blue,lightblue);
       }
       #abouts
       {
          margin-top: 25px;
          ...
          width: 100%;
          border-radius: 40%;
          background: linear-gradient(white,lightgrey,gray);
       }
        .social-media
       {
        background: black;
    ...
    <nav class="navbar navbar-expand-sm bg-info navbar-dark">
       <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
           ...
           <ul class="navbar-nav">
             <li class="nav-item">
               <a class="nav-link text-white fs-6" href="login.php">Home</a>
             </li>
             <li class="nav-item">
               <a class="nav-link text-white fs-6" href="#">About</a>
             </li>
             <li class="nav-item">
               <a class="nav-link text-white fs-6" href="contact.php">Contact</a>
             </li>
...
<br><br> 
           <div class="row"id="about">
            <center>
            <div class="col-lg p-5" id="abouts" >
                <h4 style="color:black;font-weight: bold;">Organization Profile</h4>
                <h5 style="color:black;">About SMS</h5>  
          ...
          <div class="row">
            <div class="col-lg">
                <img src="image/image3.jpg" width="60%">
            </div>
            <div class="col-md">
               <h3 style="text-decoration: underline;font-weight: bold;">About SMS</h3>
               <br>
               <h4>The main purpose of an SIS is to streamline major activities like student information and make it accessible to teachers, higher education campus leaders, students, faculty, and academicians so that they have accurate data in their hands whenever they need it.

               Managing an educational institute needs you to be extremely good at planning. An SIS will help you in automating your planning process effortlessly.</h4>
               <h4>A student information management system also has a comprehensive dashboard with a single view of student details. In this feature, you get a complete student portfolio and details about their enrollment, assessments, registration, library, research, publications, etc.
               <br>
               Moreover, you can sync their transcripts, degree path, promotions, report cards and graduations.</h4>
               
            </div>
              <div class="row">
             
              <div class="col-md">
                  <h4>Maintaining discipline within the higher education campuses is hard. Adapting a student database management system is a great way to take care of the disciplinary issues and generate actions to compare, analyse, and report discipline across the departments.</h4>
                  <h4>With this feature, you can send mass notifications or individual messages to the students. Don’t let your students miss any important updates or announcements anymore!</h4>
              </div>
               <div class="col-md">
                  <img src="image/BC.jpg" width="60%">
              </div>
              </div>
          </div>
         </center>
